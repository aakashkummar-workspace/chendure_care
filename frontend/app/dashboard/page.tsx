...
import { Search, Bell, Video, MapPin, Calendar, Clock, ChevronLeft, ChevronRight, ArrowRight } from 'lucide-react';
  ...
  return (
    <div className="relative w-36 h-36">
      <svg className="w-full h-full -rotate-90" viewBox="0 0 120 120">
        <circle cx="60" cy="60" r={radius} fill="none" stroke="#e8f5f0" strokeWidth="10" />
        <circle
          cx="60"
          cy="60"
          r={radius}
        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            <h1 className="text-2xl font-bold text-gray-900">
              Hi, <span className="text-teal-700">Samantha W.</span>
            </h1>
            <p className="text-gray-400 text-sm mt-1">Let&apos;s track your health daily!</p>
          </div>
          <div className="flex items-center gap-4">
            ...
            <button className="w-10 h-10 bg-white rounded-xl flex items-center justify-center shadow-sm hover:shadow-md transition-shadow relative">
            ...
            <div className="w-10 h-10 rounded-xl bg-teal-100 flex items-center justify-center">
              <span className="text-teal-700 font-bold text-sm">SW</span>
            </div>
          </div>
        </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-3xl p-6 shadow-sm">
              ...
              <div className="flex flex-col md:flex-row gap-6">
                ...
                <div className="w-full md:w-48 h-32 bg-teal-50 rounded-2xl flex items-center justify-center overflow-hidden flex-shrink-0">
                  <div className="text-center">
                    <div className="w-16 h-16 mx-auto bg-teal-100 rounded-2xl flex items-center justify-center mb-2">
                    ...
                    <p className="text-[10px] text-teal-600 font-medium">Hospital</p>
                  </div>
                </div>
                ...
                <div className="flex-1">
                  <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-full bg-teal-100 flex items-center justify-center">
                        <span className="text-teal-700 font-bold text-xs">EW</span>
                      </div>
                      <div>
                        <p className="font-semibold text-gray-900 text-sm">Dr. Emilia Winson</p>
                        <p className="text-xs text-gray-400">Physiotherapy</p>
                      </div>
                    </div>
                    <span className="flex items-center gap-1.5 bg-teal-50 text-teal-700 text-xs font-semibold px-3 py-1.5 rounded-lg">
                  ...
                  <div className="bg-gray-50 rounded-xl p-3 mt-3">
                    ...
                    <p className="text-xs text-gray-400 ml-5.5 mt-0.5">New York, USA</p>
                  </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-white rounded-3xl p-6 shadow-sm">
                <div className="flex justify-between items-center mb-2">
                  <div>
                    <h2 className="text-lg font-bold text-gray-900">Patient activities</h2>
                    <p className="text-xs text-gray-400 mt-0.5">Today, {now.toLocaleDateString('en-US', { day: 'numeric', month: 'long', year: 'numeric' })}</p>
                  </div>
                  <select className="text-xs bg-gray-50 border border-gray-200 rounded-lg px-3 py-1.5 text-gray-600 font-medium focus:outline-none focus:ring-1 focus:ring-teal-500">
                    <option>Month</option>
                    <option>Week</option>
                    <option>Day</option>
                  </select>
                ...
                <div className="mt-4 flex items-center gap-3 bg-teal-50 rounded-xl p-3">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-teal-800">Good conditions</p>
                    <p className="text-[11px] text-teal-600">Anxiety & wellness</p>
                  </div>
              ...
              {/* Daily Progress */}
              <div className="bg-white rounded-3xl p-6 shadow-sm flex flex-col items-center justify-center">
                <h2 className="text-lg font-bold text-gray-900 self-start mb-1">Daily progress</h2>
                <p className="text-xs text-gray-400 self-start mb-6">Keep improving the quality of your health</p>
                ...
                <div className="flex gap-6 mt-6">
                  ...
                  <div className="flex items-center gap-2">
                    <span className="w-2.5 h-2.5 rounded-full bg-teal-100" />
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-3xl p-6 shadow-sm">
              <div className="flex justify-between items-center mb-4">
                <h2 className="text-lg font-bold text-gray-900">List of appointments</h2>
              </div>
              ...
              <div className="mb-5">
                <div className="flex justify-between items-center mb-4">
                  <h3 className="text-sm font-bold text-gray-900">{MONTHS[calMonth]} {calYear}</h3>
                  ...
                  {calendarDays.map((d, i) => (
                    <button
                      ...
                      className={cn(
                        ...
                        d.current && !d.today && "text-gray-700 hover:bg-teal-50",
                        d.today && "bg-teal-600 text-white font-bold shadow-md shadow-teal-200"
                      )}
                    >
                      {d.day}
                    </button>
              ...
              <div className="space-y-3">
                {scheduleItems.map((item, idx) => (
                  <div key={idx} className="flex items-center gap-3 p-3 rounded-xl hover:bg-gray-50 transition-colors group cursor-pointer">
              ...
              <button className="flex items-center gap-2 text-teal-600 text-sm font-semibold mt-4 hover:text-teal-700 transition-colors w-full justify-center">
